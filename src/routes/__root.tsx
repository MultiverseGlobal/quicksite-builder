...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Nexus Learning Hub is a leading training, research, and management consulting firm in Nigeria, bridging policy, practice, and professional development." },
      { name: "author", content: "Nexus Learning Hub" },
      { property: "og:title", content: "Nexus Learning Hub — Building Capacity. Driving Excellence." },
