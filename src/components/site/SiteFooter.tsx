      ...
      <div className="mx-auto grid max-w-6xl gap-10 px-6 py-14 md:grid-cols-4">
        <div className="md:col-span-2">
          <div className="flex items-center gap-2.5">
            <span className="grid h-9 w-9 place-items-center rounded-sm bg-accent text-accent-foreground font-display text-lg font-bold">
              N
            </span>
            <span className="font-display text-lg font-semibold">Nexus Learning Hub</span>
          </div>
        ...
        <div>
          ...
          <ul className="mt-4 space-y-3 text-sm text-primary-foreground/80">
            ...
            <li className="flex gap-3"><Phone className="mt-0.5 h-4 w-4 shrink-0 text-accent" /><a href="tel:+2348034928531" className="hover:text-accent">+234 803 492 8531</a></li>
